...
const init = async () => {
  try {
        ...
        .testRawParams({
          ...
          headers:
            (document.getElementById('test-params-headers-input').value
              && JSON.parse(document.getElementById('test-params-headers-input').value))
            || {},
        })
        .then((res) => {
          out.value = res;
    ...
    document.getElementById('create-oracle-button').addEventListener('click', () => {
      ...
      factory
        .createOracle({
          ...
          JSONPath: document.getElementById('create-oracle-jsonpath-input').value,
          dataType: document.getElementById('create-oracle-datatype-input').value,
          headers:
            (document.getElementById('create-oracle-headers-input').value
              && JSON.parse(document.getElementById('create-oracle-headers-input').value))
            || {},
        })
        .subscribe({
          error: (e) => {
    ...
    document.getElementById('update-oracle-from-params-button').addEventListener('click', () => {
    ...
    document.getElementById('update-oracle-from-cid-button').addEventListener('click', () => {
      const out = document.getElementById('update-oracle-from-cid-out');
      out.value = '';
      out.classList.remove('error');
      factory
        .updateOracle(document.getElementById('update-oracle-from-cid-cid-input').value)
        .subscribe({
          error: (e) => {
            out.classList.add('error');
            out.value += 'ERROR\n';

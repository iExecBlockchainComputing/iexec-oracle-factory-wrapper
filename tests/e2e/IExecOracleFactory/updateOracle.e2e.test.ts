...
import { DEFAULT_WORKERPOOL_ADDRESS } from '../../../src/config/config.js';
  ...
  describe('without using voucher', () => {
    ...
    test(
      ...
      async () => {
        ...
        expect(messages[6].order.workerpool.toLowerCase()).toStrictEqual(
          DEFAULT_WORKERPOOL_ADDRESS.toLowerCase()
        );
        ...
        expect(messages[7].order.workerpool.toLowerCase()).toStrictEqual(
          DEFAULT_WORKERPOOL_ADDRESS.toLowerCase()
        );
        ...
        expect(
          messages[9].workerpoolorder.workerpool.toLowerCase()
        ).toStrictEqual(DEFAULT_WORKERPOOL_ADDRESS.toLowerCase());
        ...
        expect(messages[9].requestorder.workerpool.toLowerCase()).toStrictEqual(
          DEFAULT_WORKERPOOL_ADDRESS.toLowerCase()
        );
    ...
    test(
      ...
      async () => {
        ...
        expect(messages[8].order.workerpool.toLowerCase()).toStrictEqual(
          DEFAULT_WORKERPOOL_ADDRESS.toLowerCase()
        );
        expect(messages[8].order.beneficiary).toStrictEqual(
          consumerWallet.address
        ...
        expect(messages[9].order.workerpool.toLowerCase()).toStrictEqual(
          DEFAULT_WORKERPOOL_ADDRESS.toLowerCase()
        );
        ...
        expect(
          messages[10].workerpoolorder.workerpool.toLowerCase()
        ).toStrictEqual(DEFAULT_WORKERPOOL_ADDRESS.toLowerCase());
        ...
        expect(
          messages[10].requestorder.workerpool.toLowerCase()
        ).toStrictEqual(DEFAULT_WORKERPOOL_ADDRESS.toLowerCase());
